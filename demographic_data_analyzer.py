...
def calculate_demographic_data(print_data=True):
    ...
    # percentage_bachelors = (bachelors_count/total_counts) * 100

    education_counts = df['education'].value_counts()
    percentage_bachelors = (education_counts.get("Bachelors",0)/len(df)) * 100
    ...
    country_percentage = (country_counts/df['native-country'].value_counts())*100
    highest_earning_country = country_percentage.idxmax()
    highest_earning_country_percentage  = country_percentage.max()
